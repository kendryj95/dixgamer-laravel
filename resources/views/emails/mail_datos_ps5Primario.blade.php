  ...
  <br />
                  ...
                  5) Arriba a la derecha en Configuración > Usuarios y cuentas > Otro > Uso compartido de consola y juego offline. Seleccionar <b>Activar</b> <br />
                    @if (strpos($juego, "retro") !== false)
                        ...
                        <br>
                    @else
                        6) Ir a “Biblioteca de juegos” e ingresar al juego comprado. En los 3 puntos, seleccionar la opción “Ver producto” y aparecerá “Free PS5 Digital Upgrade”. Seleccionar “Download”, luego “Confirm Purchase” e iniciar la descarga del juego para PS5.<br />
                    @endif

                  7) Cambiar a tu usuario personal, no volver a abrir nuestro usuario.<br />
                  8) Subir una foto a IG con etiqueta @dixgamer.ok para ganar un cupón.<br />
