    ...
    <center style="width: 100%; background: #eee;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                ...
                <p><em style="color:#999;">Leer COMPLETO para disfrutar tu PS PLUS Secundario.</em></p>
                <br />
...
<em>(incluir el punto y si hay gui&oacute;n medio tambi&eacute;n, son todas letras min&uacute;sculas, ninguna may&uacute;scula)</em><br />
  ...
  <br />
                  3) <strong>Iniciar Sesi&#243;n</strong> y aceptar los datos de la cuenta (next / continue)<br />
                    ...
                    5) <span style="color: #e74c3c;">Si te pregunta cambiar tu PS4 principal: <strong>NO CAMBIAR</strong></span><br />
                  <p><em style="color:#999;">Al completar estos pasos vas a poder disfrutar de todos los beneficios de PS PLUS en esta cuenta.</em></p>
                  <p><font color="#999999"><em>Al completar los 12 meses volvemos a ofrecerte renovar la suscripcion por 12 meses mas en caso de que quieras hacerlo.</em></font></p></p>
                  <br />
                    ...
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-top:2px solid #efefef;">
                    	<tr>
                          <td align="justify" style="padding: 20px 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #666;">
                                                        <p><strong>&gt; &iquest;Puedo compartir la cuenta? NO,</strong> la cuenta sirve para una consola, si se comparte reportamos a Sony y te damos de baja, <strong>perd&eacute;s tu {{(strpos($row_rsClient->titulo,'plus') === false) ? 'juego' : 'Ps Plus'}} para siempre.</strong></p>
                            @if (strpos($row_rsClient->titulo,'plus') === false)
