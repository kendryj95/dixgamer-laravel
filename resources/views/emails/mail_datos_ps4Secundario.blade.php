...
<body bgcolor="#222222" width="100%" style="margin: 0;">
    <center style="width: 100%; background: #eee;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <!-- 1 Column Text : BEGIN -->
            <tr>
                <td bgcolor="#ffffff" style="padding: 40px 40px; text-align: left; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"><p style="font-size:18px">Hola {{ $row_rsClient->nombre }} {{ $row_rsClient->apellido }}!</p>
                  <p></p>
...
<em>(Si hay gui&oacute;n medio escribirlo tambi&eacute;n, son todas letras min&uacute;sculas, ninguna may&uacute;scula)</em><br />
  ...
  <br />
					...
					7) Sube una foto a IG, etiquetanos @dixgamer.ok y gana un cupon.
                    @if(isset($juego) && strpos(strtolower($juego), "fifa") !== false)
                        8) Al iniciar Fifa por primera vez crear la cuenta de EA Sport con tu email personal, si creas con el nuestro te banean el juego.
                    @endif
