...
1
				...
				<?php if (strpos($sc->consola, 'ps4') !== false):?>
					...
					@if ($sc->recup == 2)
						...
						<button class="btn-xs btn-info label email-info" onclick="envioEmailInfo('btns_recu_pri','{{$sc->clientes_id}}','{{$account->ID}}','{{$sc->id}}','{{$sc->ID_stock}}',this)">enviar datos <i aria-hidden="true" class="fa fa-paper-plane"></i></button>
					...
					@else
						...
						<button class="btn-xs btn-info label email-info" onclick="envioEmailInfo('msj_react','{{$sc->clientes_id}}','{{$account->ID}}','{{$sc->id}}','{{$sc->ID_stock}}',this)">enviar datos <i aria-hidden="true" class="fa fa-paper-plane"></i></button>
					...
					@if ($sc->recup == 2)
						...
						<button class="btn-xs btn-info label email-info" onclick="envioEmailInfo('btns_recu_secu','{{$sc->clientes_id}}','{{$account->ID}}','{{$sc->id}}','{{$sc->ID_stock}}',this)">enviar datos <i aria-hidden="true" class="fa fa-paper-plane"></i></button>
					...
					<button class="btn-xs btn-info label email-info" onclick="envioEmailInfo('msj_pass','{{$sc->clientes_id}}','{{$account->ID}}','{{$sc->id}}','{{$sc->ID_stock}}',this)">enviar datos <i aria-hidden="true" class="fa fa-paper-plane"></i></button>
