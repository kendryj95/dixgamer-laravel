          ...
          <div>
            ...
            <div style="position:relative; overflow:hidden; padding-bottom:100%;">
              ...
              <a title="vender {{$stock->titulo}}"
                  href="javascript:void(0)" data-toggle="modal" data-target=".modalConfirm" onclick="$('#modalVentas').modal('hide');getPageAjax('{{ url('customer_confirmUpdateProduct',[$stock->consola,$stock->titulo,'No',$id_ventas]) }}','#modalConfirm')">
