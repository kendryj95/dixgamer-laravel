          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ url('/cuentas_vacias') }}"><i class="fa fa-list fa-fw" aria-hidden="true"></i> Vacias</a></li>
                ...
                <li><a href="{{ url('con_tc_sin_juego') }}"><i class="fa fa-list fa-fw" aria-hidden="true"></i> Con TC sin Juego</a></li>
                <li class="divider" role="separator"></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="{{ url('sales/prod_excluidos_recupero') }}"><i class="fa fa-list fa-fw" aria-hidden="true"></i> Prod. Excluidos Recupero</a></li>
        <!--
          ...
          @if(session()->get('usuario')->Nombre == 'Betina')
