...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
	...
	$sql = "INSERT INTO stock (titulo, consola, medio_pago, costo_usd, costo, code, code_prov, Notas, usuario) VALUES";
	...
	if("" !== trim($_POST['code1'])){$sql .= " ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code1, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code2'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code2, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code3'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code3, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code4'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code4, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code5'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code5, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code6'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code6, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code7'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code7, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code8'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code8, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code9'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code9, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code10'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code10, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code11'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code11, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code12'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code12, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code13'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code13, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code14'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code14, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code15'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code15, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code16'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code16, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code17'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code17, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code18'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code18, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code19'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code19, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code20'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code20, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code21'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code21, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code22'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code22, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code23'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code23, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code24'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code24, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code25'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code25, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code26'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code26, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code27'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code27, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code28'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code28, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code29'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code29, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code30'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code30, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code31'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code31, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code32'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code32, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code33'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code33, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code34'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code34, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code35'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code35, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code36'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code36, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code37'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code37, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code38'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code38, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code39'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code39, $code_prov, $Notas, $usuario) ";}
	if("" !== trim($_POST['code40'])){$sql .= " , ($titulo, $consola, $medio_pago, $costo_usd, $costo, $code40, $code_prov, $Notas, $usuario) ";}
		
	mysql_select_db($database_Conexion, $Conexion);
  	$Result1 = mysql_query($sql, $Conexion) or die(mysql_error());
	
  $insertGoTo = "stock_insertar_codigos.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<!-- InstanceBeginEditable name="doctitle" -->
    <title><?php $titulo = 'Gift Cards'; echo $titulo; ?></title>
	  <style>
  ...
  <?php include('_barra_nav.php'); ?>
    ...
    <div class="col-sm-5">
         <input id="clientes" type="text" class="form-control typeahead" autocomplete="off" spellcheck="false" value=""><br /><br />
            ...
            <div class="col-sm-5">
				<textarea rows="5" id="cod_bruto" name="cod_bruto"></textarea><br>
			...
			<div class="col-sm-5">
				<textarea rows="5" id="Proveedor_data" name="Proveedor_data" hidden></textarea><br>
				<!--- no uso mas el boton <input class="btn btn-xs btn-success" type="button" onClick="javascript:generateTableProveedor()" value="Trasladar Proveedor Codes" /> -->
			</div>
            ...
            <div class="col-sm-2">
				...
				<input type="hidden" name="code_prov" value="P1">
	...
	<script>
		window.setInterval(function() {
			var str = $('textarea[name=cod_bruto]').val(); 
			var nstr = str.replace(/-/g, '');
			//var res = str.slice(str.indexOf(/Code:/g) + 8);
			var arr = nstr.match(/Voucher Code: \w+/g).map(function( m ){
			return m.replace('Voucher Code: ','');
		});
			document.getElementById("Proveedor_data").innerHTML = arr;
	...
	<script type="text/javascript">
	window.setInterval(function() {
	  var data = $('textarea[name=Proveedor_data]').val();
	...
	<!--- Controlo que se ingrese un valor para multiplicando -->
    <script type="text/javascript">
