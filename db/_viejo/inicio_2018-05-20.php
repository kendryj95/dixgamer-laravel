...
// si recibi un OII quito toda la construcción de la pagina y dejo solo el stock
if (!($colname_rsOII > 0)):?>
<!DOCTYPE html>
  ...
  <?php include('../_barra_nav.php'); ?>
    ...
    <div class="row">
              ...
              <div class="thumbnail" >
                 <div>
					<div style="position:relative; overflow:hidden; padding-bottom:100%;">
					 ...
					 <a title="vender <?php echo $row_rsStockNuevo['titulo']; ?>" href="../ventas_insertar.php?id=<?php echo $row_rsStockNuevo['ID_stk']; ?>">
              	...
              	<div>
					<div style="position:relative; overflow:hidden; padding-bottom:100%;">
					 <span style="position:absolute; z-index:100; bottom: 0px; background-color: rgba(0, 0, 0, 0.8); color:#FFF; padding:3px; font-size:0.9em;"><?php echo str_replace('-', ' ', $row_rsPrimario['titulo']);?></span>
                 		<a title="vender <?php echo $row_rsPrimario['titulo']; ?>" href="../ventas_insertar.php?id=<?php echo $row_rsPrimario['ID_stk']; ?>&slot=Primario">
		...
		<div class="row">
             	...
             	<div>
					<div style="position:relative; overflow:hidden; padding-bottom:100%;">
					 <span style="position:absolute; z-index:100; bottom: 0px; background-color: rgba(0, 0, 0, 0.8); color:#FFF; padding:3px; font-size:0.9em;"><?php echo str_replace('-', ' ', $row_rsSecundario['titulo']);?></span>
                 		 <a title="vender <?php echo $row_rsSecundario['titulo']; ?>" href="../ventas_insertar.php?id=<?php echo $row_rsSecundario['ID_stk']; ?>&slot=Secundario">
              	...
              	<div>
					<div style="position:relative; overflow:hidden; padding-bottom:100%;">
					 <span style="position:absolute; z-index:100; bottom: 0px; background-color: rgba(0, 0, 0, 0.8); color:#FFF; padding:3px; font-size:0.9em;"><?php echo str_replace('-', ' ', $row_rsPS3['titulo']);?></span>
                 		<a title="vender <?php echo $row_rsPS3['titulo']; ?>" href="../ventas_insertar.php?id=<?php echo $row_rsPS3['ID_stk']; ?>">
          ...
          <?php endif; ?>
          </div> <?php if (!($colname_rsOII > 0)):
					// si hay OII quito todo esto?>
     <!--/row-->
     <!-- InstanceEndEditable -->
    </div><!--/.container-->
...
<!-- InstanceEnd --></html>
<?php // cierro la condicion del ultimo OOI
endif;?>
<?php 
