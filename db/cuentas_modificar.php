...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
		$modificaciones = sprintf("INSERT INTO cuentas_modif(cuentas_id, mail_fake, mail, pass, name, surname, Day, verificado, usuario ) SELECT ID, mail_fake, mail, pass, name, surname, '$date', '$verificado', '$vendedor' FROM cuentas WHERE ID=%s",GetSQLValueString($_POST['ID'], "int"));
		mysql_select_db($database_Conexion, $Conexion);
  		$ResultadoModif = mysql_query($modificaciones, $Conexion) or die(mysql_error());
  
  $updateSQL = sprintf("UPDATE cuentas SET mail=%s, mail_fake=%s, pass=%s, name=%s, surname=%s WHERE ID=%s", 
  ...
  <?php include('_barra_nav.php'); ?>
    ...
    <em class="text-muted"><?php echo $row_rsClientes['mail']; ?></em>
            <div id="user-result-div" class="input-group form-group">
              ...
              <input value="<?php echo $row_rsClientes['mail']; ?>" class="form-control" type="text" name="mail" id="mail" autocomplete="off" spellcheck="false" placeholder="Mail Real" autofocus>
              <span class="input-group-addon"><i id="user-result" class="fa fa-pencil" aria-hidden="true"></i></span>
            </div>
    <em class="text-muted"><?php echo $row_rsClientes['mail_fake']; ?></em>
            <div id="user-result-div" class="input-group form-group">
              <span class="input-group-addon"><i class="fa fa-envelope-o fa-fw"></i></span>
              <input value="<?php echo $row_rsClientes['mail_fake']; ?>" class="form-control" type="text" name="mail_fake" id="mail_fake" autocomplete="off" spellcheck="false" placeholder="Mail Fake" autofocus>
              <span class="input-group-addon"><i id="user-result" class="fa fa-pencil" aria-hidden="true"></i></span>
            </div>
            <em class="text-muted"><?php echo $row_rsClientes['name']; ?></em>
            <div class="input-group form-group">
              <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
              <input class="form-control" type="text" value="<?php echo $row_rsClientes['name']; ?>" name="name" placeholder="Name">
            </div>
            <em class="text-muted"><?php echo $row_rsClientes['surname']; ?></em>
            <div class="input-group form-group">
              <span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
              <input class="form-control" value="<?php echo $row_rsClientes['surname']; ?>" type="text" name="surname" placeholder="Surname">
            </div>
            <em class="text-muted"><?php echo $row_rsClientes['pass']; ?></em>
            <div class="input-group form-group">
              <span class="input-group-addon"><i class="fa fa-key fa-fw"></i></span>
              <input class="form-control" value="<?php echo $row_rsClientes['pass']; ?>" type="text" name="pass">
            </div>
            <br />
