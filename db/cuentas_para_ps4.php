...
mysql_select_db($database_Conexion, $Conexion);
$query_rsClientes = "SELECT * FROM (SELECT COUNT(*) as Q, stock.ID as ID_stk, costo_usd, GROUP_CONCAT(consola) as cons, cuentas_id, cuentas.ID as ID, mail, mail_fake FROM stock
LEFT JOIN cuentas 
ON stock.cuentas_id = cuentas.ID 
WHERE cuentas_id IS NOT NULL
GROUP BY cuentas_id) AS rdo
WHERE cons NOT LIKE '%ps4%' and cons!='ps' AND ID!='5288' and (costo_usd='10.00' or costo_usd='20.00' or costo_usd='30.00' or costo_usd='40.00' or costo_usd='50.00' or costo_usd='60.00' or costo_usd='70.00' or costo_usd='80.00' or costo_usd='90.00' or costo_usd='100.00' or costo_usd='110.00' or costo_usd='120.00' or costo_usd='130.00' or costo_usd='140.00') and cuentas_id>4500
