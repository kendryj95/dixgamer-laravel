...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cuentas_notas (cuentas_id, Notas, Day, usuario) VALUES (%s, %s, '$date', '$vendedor')",
...
<html lang="es">
  <head>
    ...
    <title><?php $titulo = 'Agregar Nota - Cuenta #' . $colname_rsCuentas; echo $titulo; ?></title>
