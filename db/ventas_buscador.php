...
$bd_tabla = "ventas"; // Tabla donde se harán las búsquedas
$link = $Conexion;
...
<!-- InstanceEndEditable -->
  ...
  <?php include('_barra_nav.php'); ?>
    ...
    <form class="form-inline" name="buscador" method="post" action="ventas_buscador.php"><br>
    <div class="form-group">
    	<label for="campo">Buscar en: </label><select name="campo" id="campo">
    <?php
    ...
    $query = "SELECT ventas.ID as ID, ventas.clientes_id, clientes.nombre, clientes.apellido, clientes.email from $bd_tabla LEFT JOIN clientes on ventas.clientes_id = clientes.ID WHERE ventas.`{$_POST['campo']}` LIKE '%{$_POST['palabra']}%' ORDER BY ID DESC; ";
    ...
    ?>
        ...
        <td>#<?php echo $row['clientes_id']; ?> <a title="Ir a Cliente." href="clientes_detalles.php?id=<?php echo $row['clientes_id']; ?>"><?php echo $row['nombre']; ?> <?php echo $row['apellido']; ?></a></td>
        <td align="right"><a title="Ir a Cliente." href="clientes_detalles.php?id=<?php echo $row['clientes_id']; ?>"><span class="E-mail"><?php echo $row['email']; ?></span></a></td>
    <?php } echo "</tr>";
