...
WHERE ID_ventas = '%s' AND clientes_id = '%s' AND stock_id = '%s' AND estado != 'listo'
...
if ($row_rsClient){
  $insertSQL = sprintf("INSERT INTO estados (ventas_id, concepto, Day) VALUES (%s, 'listo', '$date')",$colname_rsClient);
  mysql_select_db($database_Conexion, $Conexion);
  $Result1 = mysql_query($insertSQL, $Conexion) or die(mysql_error());
  $deleteSQL = sprintf("UPDATE ventas SET estado='listo' WHERE ID=%s",$colname_rsClient);
  mysql_select_db($database_Conexion, $Conexion);
...
<center style="width: 100%; background: #eee;">
    ...
    <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
				<td align="center" height="250" background="https://dixgamer.com/img/web/mails/encabezado-nuevo.jpg" style=" background-repeat: no-repeat; background-position: center middle;">
				</td>
            </tr>
    ...
    <br />
    <i class="fa fa-check-circle-o fa-fw fa-5x text-success"></i> <br /><br />
    <strong>Gracias por confirmar</strong><br />
                  Ahora solo queda esperar a finalizar la descarga y ....<br />
                  &iexcl;Disfrutar tu nuevo juego!<br />
                  <br /><br />

                <div class="alert alert-success" style="font-size:1.2em; font-weight:bolder; padding:40px;">
                    <h3 style="margin:0px;"><i class="fa fa-shopping-bag fa-fw"></i> Ver Ofertas</h3><br />
                    <p>Encontra nuestras ofertas a precios bajos en <a class="alert-link" href="https://dixgamer.com/" target="_self">nuestra tienda online</a></p><br />
                    <p><a class="btn btn-success" href="https://dixgamer.com/">Ir a la Tienda</a></p>
                </div>
                <br />
                <div class="alert alert-info" style="text-align:left;">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    <h4><i class="fa fa-facebook-official fa-1x"></i> estamos en facebook</h4><br />
                    <p>Sumate a nuestros miles de fans en <a class="alert-link" href="https://facebook.com/dixgamer.arg/" target="_self">facebook</a>, enterate de los ultimos lanzamientos, nuestras ofertas y muchas otras novedades...</p><br />
                    <p><a class="btn btn-primary" href="https://facebook.com/dixgamer.arg/">Seguir en Facebook</a> <a class="btn btn-link" href="https://dixgamer.com/">o Ver Tienda On-line</a></p>
                </div>
