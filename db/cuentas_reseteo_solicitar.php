...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO resetear (cuentas_id, Day, Notas, usuario) VALUES (%s, '$date', %s, '$vendedor')",
...
<html lang="es">
  <head>
    ...
    <title><?php $titulo = 'Pediro Reseteo - Cuenta #' . $colname_rsCuentas; echo $titulo; ?></title>
