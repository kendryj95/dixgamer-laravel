...
$insertSQL1 = sprintf("INSERT INTO mercadopago_baja (concepto, ref_op, importe, saldo) SELECT 'Anulación de Ingreso por envío', ref_op, (%s * -1), saldo FROM mercadopago WHERE ref_op=%s LIMIT 1",
