...
<body bgcolor="#222222" width="100%" style="margin: 0;">
    ...
    <br />
<strong>¿Ya est&aacute;s descargando?</strong> click aqu&iacute;:<br /><br />
                ...
                <td bgcolor="#444" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    ...
                    <div>
                        <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top:2px solid #999;">
                            <tr>
                                <td valign="middle" style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;"><p dir="ltr">Si ya iniciaste la descarga o mejor a&uacute;n si ya lo est&aacute;s jugando... no olvides confirmarlo haciendo click! &iquest;Para qu&eacute;? Para que podamos darte un buen seguimiento y asistencia t&eacute;cnica en caso de que lo necesites.</p>
                                  <p dir="ltr"><strong>&iexcl;Muchas gracias!</strong></p></td>
                            </tr>
                        </table>
                        </div>
                    <!--[if gte mso 9]>
