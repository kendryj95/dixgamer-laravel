...
<body bgcolor="#222222" width="100%" style="margin: 0;">
    <center style="width: 100%; background: #eee;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            Calificanos por tu compra, nosotros ya lo hicimos. Gracias!...
        </div>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                ...
                <p style="font-size:22px">[nombrecliente] [apellidocliente]</p>
    <br />
<strong>Calificanos por favor, nosotros ya lo hicimos.</strong><br />
(Si ya nos calificaste 
 click aqu&iacute;)<br /><br />
<a href="https://dixgamer.com/db/clientes_conf_cali.php?id=[vta_id]&amp;c_id=[clientes_id]&amp;s_id=[stock_id]" style="border-radius: 6px;font-size: 18px;line-height: 1.33333;padding: 10px 26px;background-color: #1d9d74;border-color: #198764;color: #fff;moz-user-select: none;background-image: none;cursor: pointer;display: inline-block;font-weight: normal;margin-bottom: 0;text-align: center; vertical-align: middle; white-space: nowrap; text-decoration:none;" target="_blank">Ya los califiqu&eacute;</a><br />
                ...
                <td bgcolor="#444" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    ...
                    <div>
                        <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top:2px solid #999;">
                            <tr>
                                <td valign="middle" style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;"><p dir="ltr">Con tu calificaci&oacute;n nos ayudas a seguir creciendo en el mercado y generar confianza en nuestro público que, como vos, se merece un buen servicio.</p>                                  <p dir="ltr"><strong>&iexcl;Muchas gracias!</strong></p></td>
                            </tr>
                        </table>
                        </div>
                    <!--[if gte mso 9]>
