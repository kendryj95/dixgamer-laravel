    ...
    <center style="width: 100%; background: #eee;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <tr>
                ...
                <p><em style="color:#999;">Para canjear tu c&#243;digo necesitas una cuenta de EEUU, si no tienes, crearla es gratis y f&aacute;cil. Sigue &eacute;ste tutorial: <a href="https://youtu.be/EP69k3Q1YI8" title="Tutorial crear cuenta USA" target="_blank">ver video tutorial ></a></em></p>
                <p>1) <strong>Prender</strong> la consola &gt; Ingresar a tu <strong>Cuenta</strong><br />
                ...
                <p><font color="#999999"><em>Para jugar online en todos tus usuarios de tu PS4 debes activar esta cuenta como Primaria.<br />
                  <br />
                  Activar una cuenta como Primaria:<br />
                  1) Ir a Configuración &gt; PSN/Administración de cuentas &gt; Activar como tu PS4 principal &gt; Activar 2)<br />
                  Ir a Configuración &gt; PSN/Administración de cuentas &gt; Restaurar Licencias &gt; Restaurar </em></font></p>                <br />
                                    </td>
            </tr>
            <!-- 1 Column Text : BEGIN -->
                ...
                <td bgcolor="#444" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    ...
                    <div>
                        <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top:2px solid #999;">
                            <tr>
                              <td valign="middle" style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;"><p>TE INVITAMOS</p>
                                <p>Visita nuestro sitio web: <a style="color:#FFF;" href="https://dixgamer.com" target="_blank">dixgamer.com</a></p>                                
                                <p>
                              &#xA1;Muchas Gracias!</p></td>
                            </tr>
                        </table>
