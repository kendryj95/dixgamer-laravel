...
<body bgcolor="#222222" width="100%" style="margin: 0;">
    <center style="width: 100%; background: #eee;">
        ...
        <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;">
            Calificanos en Facebook y ahorr&#225; 10% en tus pr&#243;ximas compras.
        </div>
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
            ...
            <!-- 1 Column Text : BEGIN -->
            <tr>
              <td bgcolor="#ffffff" style="padding: 40px 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"><p style="font-size:22px">&#161;Hola [nombrecliente] [apellidocliente]!</p>
                <br />
                <p style="font-size:20px; color:#777; font-weight:100;">Calificanos en Facebook y obten&#233;</p>
                <p style="font-size:46px; font-weight:bolder;">10% OFF</p>
    <p style="font-size: 20px; margin-bottom:30px; font-weight:100; color:#777;">en todas tus compras</p>
    <br />
Te ofrecemos un 10% en todas tus compras en el sitio... de por vida!<br />
A cambio te pedimos que <strong>nos apoyes en Facebook</strong> dejando una opini&#243;n positiva de tu compra y contando tu experiencia con dixgamer.com<br />
<p style="color:#777; font-style:italic; font-size:14px;">- Con tu calificaci&oacute;n nos ayudas a seguir creciendo en el mercado y generar confianza en nuestro p&#250;blico que, como vos, se merece un buen servicio -</p>
<br />
<a href="https://www.facebook.com/dixgamer.arg/reviews/" style="border-radius: 6px;font-size: 18px;line-height: 1.33333;padding: 10px 26px;background-color: #3B5998;border-color: #3B5998;color: #fff;moz-user-select: none;background-image: none;cursor: pointer;display: inline-block;font-weight: normal;margin-bottom: 0;text-align: center; vertical-align: middle; white-space: nowrap; text-decoration:none;" target="_blank">Calificar en Facebook</a><br /><br /> </td>
            </tr>
            <!-- 1 Column Text : BEGIN -->
                ...
                <td bgcolor="#444" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    ...
                    <div>
                        <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-top:2px solid #999;">
                            <tr>
                                <td valign="middle" style="text-align: center; padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #ffffff;"><p>Luego de calificarnos en Facebook respond&#233; &#233;ste email indicando tu nombre de usuario para solicitar el descuento en nuestra tienda online.<br />
                              </p>                                  <p><strong>&iexcl;Muchas gracias!</strong></p></td>
                            </tr>
                        </table>
                        </div>
                    <!--[if gte mso 9]>
