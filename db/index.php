...
if (isset($_POST['textfield'])) {
  ...
  $MM_redirectLoginSuccess = "horario.php";
  ...
  if ($loginFoundUser) {
    ...
    $aDatos = mysqli_fetch_array($LoginRS);
    $loginStrGroup  = $aDatos['Level'];
	...
	if ($_SESSION['MM_Username'] == "Victor"):  // Si es Admin lo llevo al inicio.php sino a horario.php
	  	$MM_redirectLoginSuccess2 = "inicio.php";
